...
class FeistelFunction
{
    ...
    private long expansionPermutation(int input)
    {
        ...
        return DoubleDes.genericPermutation(input, E, 32);
    }
    ...
    {
        return (int) DoubleDes.genericPermutation(input, P_BOX, 32);
    }
    ...
    int F(int input, long roundKey)
    {
        ...
        {
            SBoxOutputs <<= 4;
            SBoxOutputs |= SBoxSubstitution(i, (byte) ((output & DoubleDes.MASK_6_BITS) >> 42));
            output = output << 6;
        }
